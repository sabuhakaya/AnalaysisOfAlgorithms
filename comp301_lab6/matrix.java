...
public class matrix {
	...
	start_time= System.nanoTime();
		...
		//print_2d_array(C_2);
		System.out.println("Running time for 16*16 matrix with strassen_matrix_multiply: "+elapsed_time );
		
		// compute the elapsed time

		// part 1(d)
		// Initialise elements of matrices with random integers
		...
		System.out.println("Running time for 64*64 matrix with strassen_matrix_multiply: "+elapsed_time );
		...
		elapsed_time= end_time- start_time;
		//print_2d_array(C_2);
		System.out.println("Running time for 16*16 matrix with square_matrix_multiply: "+elapsed_time );
		...
		System.out.println("Running time for 64*64 matrix with square_matrix_multiply: "+elapsed_time );
